...
addu $t2, $t0, $t1 #armazena em $t2 a soma do conteúdo de $t0 e $t1
...
la $a0, Space #local onde está a string
syscall

subu $t2, $t0, $t1 #armazena em $t2 a subtração do conteúdo de $t0 e $t1
move $a0, $t2 #armazena o conteúdo de $t2 em $a0 
li $v0, 1 #load integer - system call for print_int
syscall
