...
div $t2, $t0, $t1 #armazena em $t2 o QUOCIENTE da DIVISÃO COM SINAL do conteúdo de $t0 e $t1
...
rem $t2, $t0, $t1 #armazena em $t2 o RESTO da DIVISÃO COM SINAL do conteúdo de $t0 e $t1
move $a0, $t2 #armazena o conteúdo de $t2 em $a0 
li $v0, 1 #load integer - system call for print_int (IMPRIME)
syscall