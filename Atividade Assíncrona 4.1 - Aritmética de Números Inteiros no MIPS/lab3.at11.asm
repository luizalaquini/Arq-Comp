...
divu $t2, $t0, $t1 #armazena em $t2 o QUOCIENTE da DIVISÃO SEM SINAL do conteúdo de $t0 e $t1
...
la $a0, Space #indica o endereço da string a ser impressa
syscall

remu $t2, $t0, $t1 #armazena em $t2 o RESTO da DIVISÃO SEM SINAL do conteúdo de $t0 e $t1
move $a0, $t2 #armazena o conteúdo de $t2 em $a0 
li $v0, 1 #load integer - system call for print_int (IMPRIME)
syscall