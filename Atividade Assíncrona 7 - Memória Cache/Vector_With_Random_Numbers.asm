...
array:	.word	0 : 33	# an array of word, for storing values.
size:	.word	33	# actual count of the elements in the array.
max: 	.word	99 	# Set upper bound to 10 (max_int=2147483647)
